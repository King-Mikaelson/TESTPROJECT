...
function CancelSupply() {
  ...
  return (
    <div className='supply__order__container form__wrapper'>
       ...
       <p className='supply__add'>Add item details to cancel an order</p>
       <form className='supply__order__form'>
        ...
        <div className='supply__order__form__group'>
        <button className='supply__order__form__button'>Cancel Order</button>
        </div>
        </form>
    </div>
  )
