...
function DamagedSupply() {
  ...
  return (
    <div className='supply__order__container form__wrapper'>
       ...
       <p className='supply__add'>Add item details to record damaged order</p>
       <form className='supply__order__form'>
        ...
        <div className='supply__order__form__group'>
        <button className='supply__order__form__button'>Damaged Order</button>
        </div>
        </form>
    </div>
  )
