        ...
        {currentPage ? (
          <>
                ...
                <form className='supply__order__form'>
                 ...
                 <button onClick={() => setCurrentPage( prevValue => !prevValue)} style={{background:"transparent", border:'1px solid var(--primary-color)', color:'var(--primary-color)'}} className='supply__order__form__button1'>Cancel</button>
                 </div>
                 </form>
       </> )  : (
        <>
